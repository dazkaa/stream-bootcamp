                ...
                <tbody>
                  @foreach ($movies as $movie)
                    <tr>
                      ...
                      <td>
                        <img src="{{ asset('storage/thumbnail/'.$movie->large_thumbnail) }}" width="70%">
                      </td>
                      <td>{{ $movie->categories }}</td>
                      <td>{{ $movie->casts }}</td>
                      <td>
                        <a href="{{ route('admin.movie.edit', $movie->id) }}" class="btn btn-sm btn-primary" ><i class="fas fa-edit"></i></a>
